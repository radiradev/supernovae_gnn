...
from net import WrapSegmentationNet


#Logging 
logger.add('log/wrapper_{time}.log')
...
for epoch in range(1, 20):
    ...
    current_val_acc = val(val_loader)
    ...
    if current_val_acc > best_val_acc:
        ...
        torch.save({
            ...
            }, f'outputs/wrapper_net_epoch{epoch}_acc_{current_val_acc:.2f}.pth')
